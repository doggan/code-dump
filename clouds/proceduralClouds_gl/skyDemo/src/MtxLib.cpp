...
// Updated : 01.08.05
// File    : MtxLib.cpp
// Desc    : A matrix/vector/quaternion utility library. Original framework presented
//           in Game Programming Gems I, by Dante Treglia II && Mark A. DeLoura.
//           Modifications/Optimizations and quaternion library by Shyam M. Guthikonda.
//--------------------------------------------------------------------
...
_mtxCM::vector2 _mtxCM::Normalized(const vector2 &a)
{
    vector2 ret(a);
    return ret.normalize();
}
// Return Normal of vector3's
_mtxCM::vector3 _mtxCM::Normalized(const vector3 &a)
{
    vector3 ret(a);
    return ret.normalize();
}
// Return Normal of vector4's
_mtxCM::vector4 _mtxCM::Normalized(const vector4 &a)
{
    vector4 ret(a);
    return ret.normalize();
}
...
float _mtxCM::DotProduct(const vector2 &a, const vector2 &b) 
{
    return a.x*b.x + a.y*b.y;
}

// Dot product of two vector3's
float _mtxCM::DotProduct(const vector3 &a, const vector3 &b) 
{
    return a.x*b.x + a.y*b.y + a.z*b.z;
}

// Dot product of two vector4's
float _mtxCM::DotProduct(const vector4 &a, const vector4 &b) 
{
    return a.x*b.x + a.y*b.y + a.z*b.z + a.w*b.w;
}

// Swap two vector2's
void _mtxCM::SwapVec(vector2 &a, vector2 &b) 
{
    vector2 tmp(a);
...
// Swap two vector3's
void _mtxCM::SwapVec(vector3 &a, vector3 &b) 
{
    _mtxCM::vector3 tmp(a);
...
// Swap two vector4's
void _mtxCM::SwapVec(vector4 &a, vector4 &b) 
{
    vector4 tmp(a);
...
_mtxCM::vector3 _mtxCM::CrossProduct(const vector3 &a, const vector3 &b) 
{
...
bool _mtxCM::NearlyEquals( const vector2& a, const vector2& b, float r ) 
{
...
bool _mtxCM::NearlyEquals( const vector3& a, const vector3& b, float r ) 
{
...
bool _mtxCM::NearlyEquals( const vector4& a, const vector4& b, float r ) 
{
...
_mtxCM::matrix33 &_mtxCM::matrix33::operator *= (const matrix33 &m) 
{
    matrix33 t;
...
_mtxCM::matrix33 &_mtxCM::matrix33::transpose() 
{
    float t;
...
// Invert the matrix33
_mtxCM::matrix33 &_mtxCM::matrix33::invert() 
{
    matrix33 a(*this);
...
_mtxCM::matrix33 _mtxCM::IdentityMatrix33() 
{
    matrix33 ret;
...
_mtxCM::matrix33 _mtxCM::TransposeMatrix33(const matrix33 &m) 
{
    matrix33 ret(m);
...
_mtxCM::matrix33 _mtxCM::InvertMatrix33(const matrix33 &m) 
{
    matrix33 ret(m);
...
_mtxCM::matrix33 _mtxCM::RotateRadMatrix33(float rad) 
{
    matrix33 ret;
    float sinA, cosA;
...
_mtxCM::matrix33 _mtxCM::TranslateMatrix33(float x, float y) 
{
    matrix33 ret;
...
_mtxCM::matrix33 _mtxCM::ScaleMatrix33(float x, float y, float z) 
{
    matrix33 ret;
...
_mtxCM::matrix44 &_mtxCM::matrix44::operator *= (const matrix44 &m) 
{
    matrix44 t;
...
_mtxCM::matrix44 &_mtxCM::matrix44::transpose() 
{
    float t;
...
// Invert the matrix44
_mtxCM::matrix44 &_mtxCM::matrix44::invert() 
{
    matrix44 a(*this);
...
_mtxCM::matrix44 _mtxCM::IdentityMatrix44() 
{
    matrix44 ret;
...
_mtxCM::matrix44 _mtxCM::TransposeMatrix44(const matrix44 &m) 
{
    matrix44 ret(m);
...
_mtxCM::matrix44 _mtxCM::InvertMatrix44(const matrix44 &m) 
{
    matrix44 ret(m);
...
_mtxCM::matrix44 _mtxCM::RotateRadMatrix44(char axis, float rad) 
{
    matrix44 ret;
    float sinA, cosA;
...
_mtxCM::matrix44 _mtxCM::RotateRadMatrix44(const vector3 &axis, float rad) 
{
    matrix44 ret;
    float sinA, cosA;
    float invCosA;
...
_mtxCM::matrix44 _mtxCM::TranslateMatrix44(float x, float y, float z) 
{
    matrix44 ret;
...
_mtxCM::matrix44 _mtxCM::ScaleMatrix44(float x, float y, float z, float w) 
{
    matrix44 ret;
...
_mtxCM::matrix44 _mtxCM::LookAtMatrix44(const vector3 &camPos, const vector3 &target, 
                                          const vector3 &camUp ) 
{
    matrix44 ret;
...
_mtxCM::matrix44 _mtxCM::FrustumMatrix44(float l, float r, 
...
//   far plane distances.
_mtxCM::matrix44 _mtxCM::PerspectiveMatrix44(float fovY, float aspect, float n, float f) 
{
    matrix44 ret;
    float angle;
    float cot;
...
//   near, and far values for the frustum boundaries.
_mtxCM::matrix44 _mtxCM::OrthoMatrix44(float l, float r, 
                                         float b, float t, float n, float f) 
{
    matrix44 ret;
    float width = r-l;
...
_mtxCM::matrix44    _mtxCM::OrthoNormalMatrix44(const vector3 &xdir, 
...
void _mtxCM::vector2::fprint(FILE* file, char* str) const 
{
    fprintf(file, "%svector2: <%f, %f>\n", str, x, y);
}

// Print a vector3 to a file
void _mtxCM::vector3::fprint(FILE* file, char* str) const 
{
    fprintf(file, "%svector3: <%f, %f, %f>\n", str, x, y, z);
}

// Print a vector4 to a file
void _mtxCM::vector4::fprint(FILE* file, char* str) const 
{
    fprintf(file, "%svector4: <%f, %f, %f, %f>\n", str, x, y, z, w);
}

// Print a matrix33 to a file
void _mtxCM::matrix33::fprint(FILE* file, char * str) const 
{
...
void _mtxCM::matrix44::fprint(FILE* file, char* str) const 
{
